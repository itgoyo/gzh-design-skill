...
- **7 套精选主题**：摸鱼绿（默认）· 红白 · 石墨极简 · 留白禅意 · 摸鱼票据 · 橄榄手记 · 币安黄 —— 每套都是自成体系的厚组件库（设计变量 + 数十个精细组件 + 视觉层级表 + 文章类型配方表）。
...
| **币安黄** | Web3、加密货币、区块链、金融科技、投资分析、DeFi |
...
| ![](https://placehold.co/12/F0B90B/F0B90B.png) `#F0B90B` | 币安黄 | Web3、加密货币、区块链、金融科技 |
